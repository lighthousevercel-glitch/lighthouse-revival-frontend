...
// An array to hold the paragraphs for easier rendering and maintenance.
const aboutText = [
        ...
        <main className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-5 gap-12 lg:gap-16 items-start">
            ...
            <div className="md:col-span-2">
              <div className="relative group w-full aspect-[3/4] max-w-sm mx-auto md:max-w-none">
                <Image
                  src="/pastor.jpg" // Make sure pastor.jpg is in your /public folder
                  alt="Pastor Manoj"
                  fill
                  className="object-cover rounded-xl shadow-2xl group-hover:shadow-primary/40 transition-shadow duration-500"
                  sizes="(max-width: 768px) 90vw, 40vw"
                />
                {/* Gradient overlay to merge the image with the background */}
                <div className="absolute inset-0 bg-gradient-to-t from-background/60 via-transparent to-transparent rounded-xl pointer-events-none" />
              </div>
